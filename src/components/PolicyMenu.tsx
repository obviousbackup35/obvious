...
export const PolicyMenu = ({
  ...
  // Mobile layout with pagination dots as hexagons - movido para cima
  return (
    <div className={`absolute inset-0 w-full h-full transition-opacity duration-500 ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
      <div className="absolute bottom-48 left-1/2 transform -translate-x-1/2 w-full max-w-xs mx-auto px-4">
