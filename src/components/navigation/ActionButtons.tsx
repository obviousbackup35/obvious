  ...
  return (
    <>
      <NavigationButton
        ...
        className="absolute left-[1.75rem] top-[12cm] p-2 transition-all duration-700"
      >
        <Hexagon 
          className="w-7 h-7" 
      ...
      {isMobile && (
        <NavigationButton
          ...
          className="mobile-menu-toggle absolute left-1/2 -translate-x-1/2 transform top-[12cm] p-2 transition-all duration-700 z-50"
          aria-label="Menu"
        >
          {isMobileMenuOpen ? (
            <X 
      ...
      <NavigationButton
        ...
        className="absolute right-[1.75rem] top-[12cm] p-2 transition-all duration-700"
      >
        {!isPlaying ? 
