        ...
        <div className="flex justify-center items-center font-montserrat text-[1.38rem] relative" style={{
          ...
          <div className="relative w-full max-w-4xl flex justify-center items-center">
            <button 
              ...
              className="absolute left-1/4 -translate-x-[calc(100%+2rem)] cursor-pointer hover:opacity-70 transition-opacity px-4 py-2 rounded-full"
            >
              C O M P A N Y
            </button>
            ...
            <button 
              ...
              className="absolute left-1/4 -translate-x-1/2 cursor-pointer hover:opacity-70 transition-opacity px-4 py-2 rounded-full"
            >
              P R O J E C T
            </button>
            ...
            <button 
              ...
              className="absolute right-1/4 translate-x-1/2 cursor-pointer hover:opacity-70 transition-opacity px-4 py-2 rounded-full"
            >
              G A L L E R Y
            </button>
            ...
            <button 
              ...
              className="absolute right-1/4 translate-x-[calc(100%+2rem)] cursor-pointer hover:opacity-70 transition-opacity px-4 py-2 rounded-full"
            >
              C O N T A C T
            </button>
          </div>
