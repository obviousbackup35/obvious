    ...
    >
      <nav className="absolute top-8 w-full">
        ...
        >
          ...
          >
            <Hexagon className="w-7 h-7" style={{ color: getTextColor(), transition: 'color 0.7s ease-in-out' }} />
          </NavigationButton>
          ...
          >
            {isMuted ? 
              <VolumeX className="w-7 h-7" style={{ color: getTextColor(), transition: 'color 0.7s ease-in-out' }} /> : 
              <Volume2 className="w-7 h-7" style={{ color: getTextColor(), transition: 'color 0.7s ease-in-out' }} />
            }
          </NavigationButton>
